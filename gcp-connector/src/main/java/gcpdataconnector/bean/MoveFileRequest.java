...
public class MoveFileRequest extends CreateFileRequest
{
    ...
    public MoveFileRequest( String bucketName, String srcFileName, String srcParentPath,
    ...
    public String getSrcFileName() { return getName(); }
